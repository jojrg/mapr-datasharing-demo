<div class="generic-container">
    <div class="panel panel-default">
        ...
        <div class="panel-heading"><span class="lead">Data Access Rules</span></div>
	            ...
	            <form ng-submit="rulectrl.submit()" name="myForm" class="form-horizontal">
                    ...
                    <div class="row">
	                    <div class="form-group col-md-12">
	                        ...
	                        <div class="col-md-7">
	                          <select class="selectpicker" ng-model="rulectrl.rule.fieldName" id="fieldname">
                                  <option ng-repeat="fieldName in fieldNames" value="{{fieldName}}">{{fieldName}}</option>
                              </select>
	                        </div>
	                    </div>
	                </div>
